...
import platform
import datetime
from deal_lib import item_sum_V,item_offset_V,position_sorted_V
...
for segment in data_segments:
    ...
    for each in segment:
        ...
        total += 1
        # 开始计算各项值
        count_item              = item_sum_V(record_history)
        offset_item             = item_offset_V(count_item)
        item_copd               = position_sorted_V(offset_item,count_item)
